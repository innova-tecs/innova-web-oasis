      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2 space-y-6 text-center lg:text-start">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-innova-purple to-innova-blue bg-clip-text text-transparent">
              {t('hero.title')}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" className="bg-gradient-to-r from-innova-purple to-innova-blue hover:opacity-90 transition-opacity">
                {t('hero.cta')}
          ...
          <div className="lg:w-1/2 relative">
            <div className="absolute -z-10 w-72 h-72 blur-3xl rounded-full bg-innova-purple/30 top-0 right-0"></div>
            <div className="relative z-10 rounded-xl overflow-hidden shadow-xl border border-white/10 backdrop-blur-sm">
              <div className="aspect-video w-full max-w-xl mx-auto overflow-hidden rounded-xl bg-gradient-to-br from-innova-purple/20 to-innova-blue/20 p-1">
                <div className="rounded-lg overflow-hidden w-full h-full border border-white/10 bg-innova-darkBg">
                  ...
                  <div className="p-4 flex flex-col gap-4">
                    ...
                    <div className="flex gap-4">
                      <div className="h-12 w-32 bg-innova-purple/50 rounded"></div>
            ...
            <div className="absolute -z-10 w-60 h-60 blur-3xl rounded-full bg-innova-blue/20 -bottom-10 -left-10"></div>
          </div>
        </div>
